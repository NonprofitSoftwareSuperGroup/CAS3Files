...
if((isset($_POST['courseSelect']) && isset($_POST['sectionSelect']))||(isset($_SESSION['course']) && isset($_SESSION['section'])))
{
	...
	while($i2<=$i)
	{
		...
		$checkCheckBox1 = isset($_POST['checkbox1'.$i2.'']) && !$_POST['checkbox1'.$i2.'']=='';
		$checkCheckBox2 = isset($_POST['checkbox2'.$i2.'']) && !$_POST['checkbox2'.$i2.'']=='';
		$checkCheckBox3 = isset($_POST['checkbox3'.$i2.'']) && !$_POST['checkbox3'.$i2.'']=='';
		$checkCheckBox4 = isset($_POST['checkbox4'.$i2.'']) && !$_POST['checkbox4'.$i2.'']=='';
		$checkCheckBox5 = isset($_POST['checkbox5'.$i2.'']) && !$_POST['checkbox5'.$i2.'']=='';
